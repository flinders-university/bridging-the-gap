class UnitPresentation < ApplicationRecord
  ...
  has_attached_file :unit_overview, path: "/btg-project/:class/:id/unit_overview/:filename", default_url: "/btg-project/:class/:id/missing.pdf", :s3_permissions => :private
  validates_attachment :unit_overview, content_type: { content_type: ["application/pdf", "application/vnd.openxmlformats-officedocument", "application/msword", "application/vnd.ms-powerpoint"] }
