...
class SignaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create signature" do
    assert_difference('Signature.count') do
      post signatures_url, params: { signature: { data: @signature.data, form_id: @signature.form_id, user_id: @signature.user_id } }
    end
  ...
  test "should update signature" do
    patch signature_url(@signature), params: { signature: { data: @signature.data, form_id: @signature.form_id, user_id: @signature.user_id } }
